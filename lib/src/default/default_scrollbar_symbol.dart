...
class DefaultScrollbarSymbol extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final textStyle = switch (state) {
      AlphabetScrollbarItemState.active => styleActive ?? TextStyle(color: Theme.of(context).colorScheme.secondary),
      AlphabetScrollbarItemState.inactive => styleInactive ?? const TextStyle(color: Colors.black),
      AlphabetScrollbarItemState.deactivated => styleDeactivated ?? const TextStyle(color: Colors.grey),
    };

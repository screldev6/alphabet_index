...
import 'package:alphabet_index/src/list.dart';
import 'package:alphabet_index/src/overlay.dart';
import 'package:alphabet_index/src/scrollbar.dart';
...
class _AlphabetListViewState extends State<AlphabetListView> {
  ...
  Widget build(BuildContext context) {
    final rowTextDirection = switch (widget.options.scrollbarOptions.forcePosition) {

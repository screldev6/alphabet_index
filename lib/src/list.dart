...
import 'package:alphabet_index/src/controller.dart';
...
class _AlphabetListState extends State<AlphabetList> {
      ...
      child: ScrollConfiguration(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            ...widget.items.map(
              (item) {
                final bool useHeaderForEmptySection = widget.alphabetListOptions.showSectionHeaderForEmptySections || !((item.childrenDelegate.estimatedChildCount ?? 0) == 0);
  ...
  void _showGroup(String symbol) {
    final RenderObject? renderObject = widget.items.firstWhere((element) => element.tag == symbol).key.currentContext?.findRenderObject();
